...
class App extends Component {
    ...
    addTask(e) {
        if(this.state._id) {
            ...
            axios.post('https://listado-tareas.herokuapp.com/api/tasks', data)
            .then(res => {
                console.log(res);
                this.setState({title: '', description: '', _id: ''});
            })
    ...
    render() {
        return (
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <h3 style={{marginLeft: '25%'}}>Listado de tareas</h3>
                    </div>
                    <div className="row">
                                            ...
                                            return (
                                                <tr key = {task._id}>
                                                    ...
                                                    <td>
                                                        ...
                                                        style={{margin: '4px'}} onClick= {() => this.editTask(task._id)}>
